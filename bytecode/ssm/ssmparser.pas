...
Unit SSMParser;
 ...
 Interface
 Uses SSCompiler, BytecodeCompiler, Opcodes, Messages, Classes, Stream, Zipper;
 ...
 Type TSSM = Class
              Private
               ...
               C1        : SSCompiler.TCompiler;
               C2        : BytecodeCompiler.TCompiler;
               FileName  : String;
               ModuleName: String;
...
Begin
 ...
 // prepare variables
 Zip := TZipper.Create;
 C1  := SSCompiler.TCompiler(pC1);
 C2  := BytecodeCompiler.TCompiler(pC2);
